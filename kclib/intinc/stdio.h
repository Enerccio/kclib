 ...
 */
size_t	 __buffer_usedsize(__buffer_t* buffer) __attribute__((nonnull (1)));
/**
 * Returns size of the buffer
 */
size_t	 __buffer_maxsize(__buffer_t* buffer) __attribute__((nonnull (1)));
/**
 * Returns empty size of the buffer
 */
size_t	 __buffer_freesize(__buffer_t* buffer) __attribute__((nonnull (1)));
/**
 * Returns head position of the buffer
 */
size_t	 __buffer_fseek(__buffer_t* buffer) __attribute__((nonnull (1)));
/**
 ...
 */
size_t	 __buffer_ftell(__buffer_t* buffer, size_t newpos) __attribute__((nonnull (1)));
/**
 * Returns size and position of data in the buffer
 */
uint8_t* __buffer_get_data(__buffer_t* buffer, size_t* len) __attribute__((nonnull (1)));
/**
 * Frees internal buffer storage, if it was autogenerated
 */
void     __free_buffer(__buffer_t* buffer) __attribute__((nonnull (1)));
/**
 * Shifts data in buffer to the left by size amount
 */
void __buffer_shift(__buffer_t* buffer, size_t sa) __attribute__((nonnull (1)));
